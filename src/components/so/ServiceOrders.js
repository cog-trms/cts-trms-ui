...
import UserTableRow from '../common/UserTableRow';
...
const ServiceOrders = ({ serviceOrder, loadServiceOrder, team, loadTeam }) => {
  ...
  const handleCellButtonClick = (id, routeText) => {
    if (routeText === 'edit') {
      history.push(`/serviceorder/${id}/edit`);
    } else {
                  ...
                  <TableRow key={index}>
                    ...
                    <TableCell align='center'>
                      <Button
                        ...
                        onClick={() => handleCellButtonClick(row.id, 'edit')}
                      >
                        Edit
                      </Button>
                    </TableCell>
                    ...
                    <TableCell align='right'>
                      <Button
                        ...
                        color='primary'
                        className={classes.cellButton}
                        onClick={() => handleCellButtonClick(row.id, 'go')}
                      >
                        Go
                      </Button>
                    </TableCell>
      ...
      <div className='table-container'>
        <div className='uk-overflow-auto'>
          <Table className='uk-table uk-table-hover uk-table-middle uk-table-divider'>
            <TableHead>
              <TableRow>
                <TableCell className='uk-table-shrink'></TableCell>
                <TableCell className='uk-table-shrink'></TableCell>
                <TableCell className={classes.business} align='left'>
                  Service Order
                </TableCell>
            ...
            <TableBody>
              {isLoading ? (
                <TableRow>
                  <TableCell colSpan={6} className='uk-text-center'>
